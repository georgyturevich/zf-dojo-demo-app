 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Crystal_Dojo_View_Helper_Tooltip extends Zend_Dojo_View_Helper_DijitContainer
{
    /**
     * Dijit being used
     * @var string
     ...
     * @return string
     */
    public function tooltip($id = null, $content = '', array $params = array(), array $attribs = array())
    {
        if (0 === func_num_args()) {
            return $this;
        }
